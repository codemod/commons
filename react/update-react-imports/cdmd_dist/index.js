...
function transform(file, api, options) {
    ...
    var destructureNamespaceImports = options === null || options === void 0 ? void 0 : options.destructureNamespaceImports;
    ...
    function isVariableDeclared(variable) {
        return (root
            ...
            return path.parent.value.type !== "MemberExpression" &&
    ...
    var reactImportPaths = root
        ...
        .filter(function (path) {
        return ((path.value.source.type === "Literal" ||
    ...
    var reactPaths = reactImportPaths.filter(function (path) {
        return (path.value.specifiers.length > 0 &&
            ...
            path.value.specifiers.some(function (specifier) { var _a; return ((_a = specifier.local) === null || _a === void 0 ? void 0 : _a.name) === "React"; }));
    });
    ...
    var reactLiteral = reactPath === null || reactPath === void 0 ? void 0 : reactPath.value.source;
    var isDefaultImport = (_a = reactPath === null || reactPath === void 0 ? void 0 : reactPath.value.specifiers) === null || _a === void 0 ? void 0 : _a.some(function (specifier) {
        var _a;
        return specifier.type === "ImportDefaultSpecifier" &&
            ((_a = specifier.local) === null || _a === void 0 ? void 0 : _a.name) === "React";
    });
    // Check to see if we should keep the React import
    var isReactImportUsed = root
        .find(j.Identifier, {
        name: "React",
    })
        .filter(function (path) {
    ...
    if (canDestructureReactVariable) {
        ...
        Object.keys(reactIdentifiers).forEach(function (local) {
            ...
            regularImports_1.push(j.importSpecifier(j.identifier(imported), j.identifier(local)));
        });
        var typeImports_1 = [];
        Object.keys(reactTypeIdentifiers).forEach(function (local) {
            var imported = reactTypeIdentifiers[local];
            typeImports_1.push(j.importSpecifier(j.identifier(imported), j.identifier(local)));
        });
        if (regularImports_1.length > 0 && reactPath) {
            j(reactPath).insertAfter(j.importDeclaration(regularImports_1, reactLiteral));
        }
        if (typeImports_1.length > 0 && reactPath) {
            j(reactPath).insertAfter(j.importDeclaration(typeImports_1, reactLiteral, "type"));
        }
        ...
        reactImportPaths.forEach(function (path) {
            ...
            // be removed
            if ((_a = path.value.specifiers) === null || _a === void 0 ? void 0 : _a.some(function (specifier) {
                var _a;
                return specifier.type === "ImportDefaultSpecifier" &&
                    ((_a = specifier.local) === null || _a === void 0 ? void 0 : _a.name) === "React" &&
                    (specifier.importKind ===
